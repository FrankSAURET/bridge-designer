...
public class Inventory {
    ...
    private final Material materials[] = new Material[]{
        new Material(0, "Acier au carbone", "CS",  200000000, 250000, 7850, new double[]{1.44, 1.55}),
        new Material(1, "Acier rapide", "HSS", 200000000, 345000, 7850, new double[]{1.55, 1.76}),
